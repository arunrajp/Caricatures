<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.master" AutoEventWireup="true" CodeFile="UploadImage.aspx.cs" Inherits="Admin_UploadImage" %>
    ...
    <div class="container">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <asp:Button ID="btnUpload" runat="server" CssClass="btn btn-success pull-right" Text="Upload" />
                    </div>
                </div>
            </div>
        </div>
